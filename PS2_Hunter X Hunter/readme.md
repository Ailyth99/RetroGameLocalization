...
&nbsp; Convert RH2 to PNG:      rh2\_tool.exe -e <file.rh2> \[out.png]

&nbsp; 

&nbsp; Batch RH2 to PNG:        rh2\_tool.exe -e <folder>

&nbsp; 

&nbsp; Convert PNG to RH2:      rh2\_tool.exe -i <src.png> <template.rh2> <out.rh2>

&nbsp; 

&nbsp; Inject PNG into CVT:     rh2\_tool.exe -c <src.png> <target.cvt> \[out.cvt]

&nbsp; 

&nbsp; Extract RH2 from CVT:    rh2\_tool.exe -x <file.cvt> \[out\_folder]
